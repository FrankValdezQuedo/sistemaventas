...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-04-2024 a las 01:54:24
...
--
ALTER TABLE `ingreso`
  ADD CONSTRAINT `ingreso_ibfk_1` FOREIGN KEY (`idproveedor`) REFERENCES `cliente` (`idcliente`),
